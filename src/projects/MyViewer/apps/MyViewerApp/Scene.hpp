...
namespace sibr
{
	...
	namespace DF_L
	{
		class BasicIBRScene : public IIBRScene
		{
		...
		public:
			...
			*/
			 ...
			 */
			BasicIBRScene(const GaussianAppArgs& myArgs, SceneOptions myOpts = SceneOptions());
	 ...
	 */
		...
		private:
			std::vector<sibr::Mesh::Ptr> m_sceneMeshes;
		public:
			void Init_SceneMeshes();
			const std::vector<sibr::Mesh::Ptr>& Get_Meshes() const { return m_sceneMeshes; }
		private:
		};
