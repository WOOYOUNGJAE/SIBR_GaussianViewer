...
namespace sibr
{
	...
	{
		enum class Type {
			EMPTY, GAUSSIAN, BLENDER, SIBR, COLMAP_CAPREAL, COLMAP, COLMAP2, NVM, MESHROOM, CHUNKED, EXTERNAL, GAUSSIAN_WITH_NORMAL,
		};
		/**
		...
		*/
		...
		class ParseData : public IParseData {
		...
		public:
			...
			*/
			...
			void getParsedOnlyPlyData(const std::string& dataset_path);
			...
			*/
			void  getParsedData(const GaussianAppArgs& myArgs, const std::string& customPath = "");
			...
			*/
			...
			const DF_L::Type& Get_datasetType(void) const
			{
				return _datasetType;
			}
			...
			*/
			...
			void											datasetType(DF_L::Type dataType);
		...
		protected:
			...
			*/
			...
			int											_numCameras;
			DF_L::Type									_datasetType = DF_L::Type::EMPTY;
		...
		inline void		ParseData::datasetType(DF_L::Type dataType) {
